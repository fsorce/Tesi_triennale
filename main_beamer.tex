...
\input{style/preamble_beamer.tex}
...
Scegliendo un multiindice $I$ di $k$ entrate
\[\Gr_I(k,n)=\cpa{[A]\in \Gr(k,n)\mid \det A_I\neq 0}.\]
cio\`e, i sottospazi supplementari a $\Span(\cpa{e_i\mid i\in I})$.\pause
...
Si pu\`o mostrare che $\Gr_I(k,n,\K)=\Gr(k,n)_{z_I}\cong \A_\K^{k(n-k)}$.\bigskip
\pause
...
\pause
\[\gr(k,n)(\Spec\K)\cong{\cpa{\vp:\K^n\onto \K^k}}/_\sim=\Gr(k,n).\]
\end{frame}
