...
Let $F:\Psh S\Set$ be a moduli problem. We say that a subfunctor $G\subseteq F$ is \textbf{open} if for any $S$-scheme $T$ and any natural transformation $h_T\to F$, the pullback $h_T\times_FG$ is representable by an open subscheme of $T$.
\end{definition}
